...
workflow{
    ...
    if (params.step == 3) {
        ...
        split_ch = in_ch.branch {sample ->
            ...
            reverse: sample[0].strandedness == 'reverse'
            auto: sample[0].strandedness == 'auto'
        }

        split_ch.forward.collect().view {"Forward:\n" + it}
        split_ch.reverse.collect().view {"Reverse:\n" + it}
        split_ch.auto.collect().view {"Auto:\n" + it}
    }
